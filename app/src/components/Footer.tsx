                ...
                <div className="ml-12 py-12 mr-12">
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-2 md:gap-8 md:space-x-12 relative">
                        ...
                        <div className="mb-6 items-center mx-auto max-w-screen-lg">
                            <div className="font-normal capitalize mb-2.5">SOLIDITY</div>

                            <div className="flex flex-col mb-0 gap-2">
                                <Link href="https://solang.readthedocs.io/en/latest/index.html" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                                    Solang
                                </Link>
                                <Link href="https://dprogramminguniversity.com/solana/ultimate-guide-to-solidity-for-solana-programs-development-with-solang-and-anchor/" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                                    Beginners Guide
                                </Link>
                                <Link href="https://solana.com/developers/guides/solang/getting-started" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                                    Solana
                                </Link>
                                <Link href="https://github.com/solana-developers/program-examples" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                                    Examples Repo
                                </Link>
                                <Link href="https://www.youtube.com/watch?v=eQt4yZ_0i3k&list=PL8wScYxE1DQAzhUb1-0qBV2z6t4HUEzrS" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                                    Examples Walkthrough
                                </Link>
                                <Link href="https://dprogramminguniversity.com/courses/smart-contract-development-with-solidity-for-beginners/" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                                    Free Solidity Course
                                </Link>
                                <Link href="https://dprogramminguniversity.com/discord" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                                    Support (Discord)
                                </Link>
                            </div>
                        </div>
